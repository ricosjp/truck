...
#[property_test]
fn test_newton1(
    #[strategy = prop::array::uniform4(-10.0f64..=10.0f64)] a: [f64; 4],
    #[strategy = -10.0f64..=10.0f64] x0: f64,
    #[strategy = -0.5f64..=0.5f64] delta: f64,
) {
...
#[property_test]
fn test_newton2(
    #[strategy = prop::array::uniform2(-10.0f64..=10.0f64)] n: [f64; 2],
    #[strategy = prop::array::uniform2(-0.5f64..=0.5f64)] delta: [f64; 2],
) {
