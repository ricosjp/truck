...
/// giving its iterator to the function monstertruck_platform::[`create_bind_group_layout`].
/// # Examples
/// ```
...
/// ```
/// use monstertruck_platform::RenderId;
...
///
/// `Scene` is the most important in `monstertruck-platform`.
