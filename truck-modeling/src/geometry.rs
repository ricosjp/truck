use super::*;
pub use truck_geometry::{specifieds::*, nurbs::*, decorators::*};
...
impl ParametricCurve for Curve {
    ...
    fn subs(&self, t: f64) -> Self::Point {
        derive_curve_method!(self, ParametricCurve::subs, t)
    }
    fn der(&self, t: f64) -> Self::Vector {
        derive_curve_method!(self, ParametricCurve::der, t)
    }
    fn der2(&self, t: f64) -> Self::Vector {
        derive_curve_method!(self, ParametricCurve::der2, t)
    }
...
impl Invertible for Curve {
    fn invert(&mut self) {
        derive_curve_method!(self, Invertible::invert,)
    }
    fn inverse(&self) -> Self {
        derive_curve_self_method!(self, Invertible::inverse,)
    }
}
...
impl Invertible for Surface {
    fn invert(&mut self) {
        derive_surface_method!(self, Invertible::invert,)
    }
    fn inverse(&self) -> Self {
        derive_surface_self_method!(self, Invertible::inverse,)
    }
}
