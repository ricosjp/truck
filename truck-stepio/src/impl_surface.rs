...
macro_rules! sub_impl_surface {
	($mod: tt) => {
		...
		impl From<&$mod::CylindricalSurface> for Processor<RevolutedCurve<Line<Point3>>, Matrix4> {
		...
		impl From<&$mod::ConicalSurface> for Processor<RevolutedCurve<Line<Point3>>, Matrix4> {
