...
const acp0: vec4<f32> = vec4<f32>(11.714964805291158, -20.083602331793195, 0.2296881862103637, 1.0000000000018192);
const acp1: vec4<f32> = vec4<f32>(-7.919279773964541, 12.919469128453738, -1.3377250768579256, -2.0000000000036002);
const acp2: vec4<f32> = vec4<f32>(-23.645933626763625, 36.55672789512988, 1.9863855950847729, 1.0000000000017617);
const acp3: vec4<f32> = vec4<f32>(19.301563694896643, -28.84390979125007, -0.8783487044372066, 0.000000000000025531539193725142);
