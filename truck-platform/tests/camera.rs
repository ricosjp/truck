...
fn parallel_view_fitting(
    #[strategy = (-1.0f64..=1.0, 0.0..2.0 * PI)] rot_axis: (f64, f64),
    #[strategy = 0.0..2.0 * PI] rot_angle: f64,
    #[strategy = 0.5f64..=10.0f64] aspect: f64,
    #[strategy = 0.01f64..=100.0] near_clip: f64,
    #[strategy = prop::array::uniform32(prop::array::uniform3(-100.0f64..=100.0f64))]
    points: [[f64; 3]; 32],
) {
    let z = rot_axis.0;
    let r = (1.0 - z * z).sqrt();
