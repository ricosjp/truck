...
pub trait PolylineableCurve: ParametricCurve<Point = Point3, Vector = Vector3> + Invertible + ParameterDivision1D<Point = Point3> {}
#[cfg_attr(rustfmt, rustfmt_skip)]
impl<C: ParametricCurve<Point = Point3, Vector = Vector3> + Invertible + ParameterDivision1D<Point = Point3>> PolylineableCurve for C {}
#[cfg_attr(rustfmt, rustfmt_skip)]
/// Gathered the traits used in tessellation.
