...
#[property_test]
fn triangle_prism(
    #[strategy = prop::array::uniform3(prop::array::uniform2(-100.0f64..100.0f64))] p: [[f64; 2];
        3],
    #[strategy = 0.1f64..100.0f64] h: f64,
    #[strategy = prop::array::uniform2(0.0f64..1.0f64)] dir_array: [f64; 2],
    #[strategy = 0.0..PI * 2.0] angle: f64,
    #[strategy = prop::array::uniform3(-100.0f64..100.0f64)] vec: [f64; 3],
) {
    ...
    prop_assert_near!(
        msolid.center_of_gravity().to_point(),
        trans.transform_point(grav)
    );
}
