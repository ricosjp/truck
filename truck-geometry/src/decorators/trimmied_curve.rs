...
impl<C: SearchNearestParameter> SearchNearestParameter for TrimmedCurve<C> {
	...
	#[inline(always)]
	fn search_nearest_parameter(&self, pt: C::Point, hint: Option<C::Parameter>, trials: usize) -> Option<C::Parameter> {
...
impl<C: SearchParameter> SearchParameter for TrimmedCurve<C> {
	...
	type Parameter = C::Parameter;
	#[inline(always)]
	fn search_parameter(&self, pt: C::Point, hint: Option<C::Parameter>, trials: usize) -> Option<C::Parameter> {
