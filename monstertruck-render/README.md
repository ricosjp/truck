...
[![Crates.io](https://img.shields.io/crates/v/monstertruck-render.svg)](https://crates.io/crates/monstertruck-render) [![Docs.rs](https://docs.rs/monstertruck-render/badge.svg)](https://docs.rs/monstertruck-render)
...
A model json file can be generated by `serde_json`. See the examples of `monstertruck-modeling`!
